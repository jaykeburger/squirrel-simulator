    ...
    public class LoftRoadBehaviour : MonoBehaviour
    {
        ...
        public Mesh LoftMesh
        {
            get
            {
                ...
                m_Mesh = new Mesh();
                GetComponent<MeshRenderer>().sharedMaterial = Resources.Load<Material>("Asphalt_material_4");
                return m_Mesh;
            }
        }
        ...
        public void Loft(Spline spline, int widthDataIndex)
        {
            ...
            if (meshRenderer != null && asphaltMaterial != null)
            {
                meshRenderer.material = asphaltMaterial;  // Assign Asphalt_material_4
            }
        }
    }
}
